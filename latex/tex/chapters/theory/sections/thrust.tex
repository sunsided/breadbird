...
\end{align}
%
As will be shown in \cref{eq:froude_rankine_proof} \vpageref{eq:froude_rankine_proof}\todo[noinline]{reference to solution}, this corresponds to the induced velocity of
%
\begin{align}
...
%
\begin{align}
F &= \dot{m} \, \Delta v = \dot{m} \parens{ v_3 - v_0 } 
\end{align}
%
