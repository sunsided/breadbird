...
%
\begin{align}
F &= \rho A_r v_i \parens{v_3 - v_1} \\
  &= \frac{1}{2} \rho A_r \parens{v_3 + v_1} \parens{v_3 - v_1} \notag \\
  &= \frac{1}{2} \rho A_r \parens{v^2_3 - v^2_1} \label{eq:thrust_mdot}
%F &= 2 \dot{m} v_i = 2 \rho A_r v^2_i \label{eq:thrust_mdot} \\
%v_i &= \sqrt{\frac{F}{2 \rho A_r}}
\end{align}

\todo[size=\Large,color=red]{where did $v_i = \sqrt{\sfrac{T}{2\rho A_r}}$ come from!?}
