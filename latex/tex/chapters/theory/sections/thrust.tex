...
%
\begin{align}
\Delta p + p_1 + \rho \frac{1}{2} v^2_i &= p_2 + \rho \frac{1}{2} v^2_i \label{eq:bernoulli_induced_deltap}
\end{align}
%
and thus obtain using \cref{eq:bernoulli_outflow,eq:bernoulli_induced_deltap}
%
\begin{align}
\Delta p &= \parens { p_\infty + \rho \frac{1}{2} v^2_3 } - \parens{ p_1 + \rho \frac{1}{2} v^2_i }
\end{align}

\todo{below there be dragons}
